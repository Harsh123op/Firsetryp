...
from shivu import application, top_global_groups_collection, pm_users, OWNER_ID, group_user_totals_collection


async def broadcast(update: Update, context: CallbackContext) -> None:
    OWNER_ID = '7058928258'  # Set the OWNER_ID directly within the function
